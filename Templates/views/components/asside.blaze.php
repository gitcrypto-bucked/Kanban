...
?>
    ...
    <aside class="w-64 bg-slate-950 border-r border-slate-800 flex flex-col p-6 space-y-6">
    <?php if(Auth::logged()) :  ?>
    ...
    <nav class="space-y-4">
         <?php 
            ...
            if(Auth::logged()) 
            {
                echo ' <a href="'.url('grupos').'" class="block hover:text-accent px-2"><i class="bi bi-people mr-1"></i>Grupos</a>';
                echo ' <a href="'.url('projetos').'" class="block hover:text-accent px-2"><i class="bi bi-cast mr-1"></i>Projetos</a>';
