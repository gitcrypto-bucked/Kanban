...
<header class="bg-gray-800 p-4 flex justify-between items-center ">
    <?php 
        ...
        if(Route::is('grupos'))
        {
            echo '<h2 class="text-xl font-bold">Grupos</h2>';
        }
        if(Route::is('add_group'))
        {
            echo '<h2 class="text-xl font-bold">Criar Grupo</h2>';
        }
        if(Route::is('projetos'))
        {
            echo '<h2 class="text-xl font-bold">Projetos</h2>';
        }
        if(Route::is('add_projeto'))
        {
            echo '<h2 class="text-xl font-bold">Criar Projeto</h2>';
        }
