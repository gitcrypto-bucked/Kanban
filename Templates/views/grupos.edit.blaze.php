  ...
  <main class="flex-1 overflow-y-auto">
    ...
    <section class="p-6 max-w-3xl">
      ...
      <div class="bg-slate-950 border border-slate-800 rounded-lg p-6 space-y-6">
        <input type="hidden" id='id' name='id' readonly value="<?=$grupo['id']?>">
        <div>
          <label class="block mb-2 text-sm">Nome</label>
          <input id="groupName" type="text"  value="<?=$grupo['nome']?>"
        ...
        <div>
          ...
          class="w-full bg-slate-800 border border-slate-700 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-accent" placeholder="Descrição do grupo"><?=$grupo['descricao']?></textarea>
        </div>
