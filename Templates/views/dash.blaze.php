<!DOCTYPE HTML>
	<?php 
		use \Core\Auth;
    @Auth::check();
    $projetos = $args['projetos'];
    $atividades = $args['atividades'];
    $done = $args['done'];
	?>
        ...
        <main class="flex-grow p-6 overflow-y-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
              <h3 class="text-lg font-semibold mb-2">Projeto(s)</h3>
              <p class="text-3xl font-bold text-accent"><?=$projetos[0]['total']?></p>
              <p class="text-sm text-gray-400 mt-2"><?=date('d/M/Y H:i:s')?></p>
            </div>
            <!-- Card 2 -->
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
              <h3 class="text-lg font-semibold mb-2">Atividades</h3>
              <p class="text-3xl font-bold text-accent"><?=(@$atividades[0]['total'])?></p>
              <p class="text-sm text-gray-400 mt-2"><?=date('d/M/Y H:i:s')?></p>
            </div>
            <!-- Card 3 -->
            <div class="bg-gray-800 p-6 rounded-lg shadow-md">
              <h3 class="text-lg font-semibold mb-2">Atividades Feitas</h3>
              <p class="text-3xl font-bold text-accent"><?=(@$done[0]['total'])?></p>
              <p class="text-sm text-gray-400 mt-2"><?=date('d/M/Y H:i:s')?></p>
            </div>
          </div>
